        ...
        <div className="container py-8">
            <div className="card">
                ...
                <div className="content">
                    <p>
                        I would like to thank everyone who supported me throughout the process of writing this paper. This project would not have been possible without the guidance and support of my advisors, teachers, friends, and family. I am grateful for their encouragement and feedback, which helped me to improve my work and stay motivated.
                    </p>
                    <p>
